...
const ContactSection = () => {
  return (
    <section id="contact" className="relative py-24 px-4 md:px-8 lg:px-16 bg-elden-dark-light/30">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fadeIn">
          ...
          <p className="font-garamond text-lg text-muted-foreground max-w-2xl mx-auto">
            Invoke this ancient rune to establish a connection across the digital veil
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 animate-slideUp">
            <div className="bg-card border border-elden-mist p-8 rounded-lg shadow-gold">
              ...
              <p className="font-garamond text-lg text-muted-foreground leading-relaxed mb-6">
                Whether you seek collaboration on mystical projects, wish to discuss the arcane arts of technology, or simply desire to forge a new connection in this vast digital realm, I welcome your message.
              </p>
              <p className="font-garamond text-lg text-foreground">
                May our paths converge toward <span className="text-gold">innovation</span> and <span className="text-gold">discovery</span>.
              </p>
            </div>

            {/* Location */}
            <div className="bg-card border border-elden-mist p-6 rounded-lg shadow-gold flex items-center gap-4">
              <div className="p-3 bg-elden-dark-light rounded-lg border border-gold">
                <MapPin className="w-6 h-6 text-gold" />
              </div>
              <div>
                <p className="font-cinzel text-lg font-semibold text-gold">Current Realm</p>
                <p className="font-garamond text-muted-foreground">Sousse, Tunisia</p>
              </div>
            </div>
          </div>
